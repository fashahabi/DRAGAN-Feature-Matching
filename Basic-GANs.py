...
class Basic_GAN(object):
    ...
    def test(self, segment_test):
        self.gen.load_weights('Basic_GAN_185.h5')
...
if __name__ == '__main__':
    ...
    for iteration in range(iterations):
        disc_loss, gen_loss, y_predict = Basic_GAN_model.train(segment_train, y_train, h_prices_train)
        ...
        if (iteration % 5) == 0 and iteration> 120:
            print(iteration)
            Basic_GAN_model.gen.save_weights('Basic_GAN_%d.h5' % iteration)
